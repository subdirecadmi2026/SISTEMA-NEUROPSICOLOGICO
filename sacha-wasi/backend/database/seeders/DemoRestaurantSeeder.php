...
class DemoRestaurantSeeder extends Seeder
{
    ...
    private function seedDishes(string $companyId, array $categories, array $units, ?string $taxId): array
    {
        ...
        $locro = Product::query()->create([
            ...
            'name' => 'Locro de papa',
            'sku' => 'PLT-LOCRO',
            'description' => 'Crema de papa chaucha, queso fresco de hacienda y un toque de cilantro. Plato de la sierra quiteña.',
            'default_price' => 6.50,
            'tracks_lots' => false,
            'is_sellable' => true,
        ...
        $seco = Product::query()->create([
            ...
            'name' => 'Seco de pollo',
            'sku' => 'PLT-SECO',
            'description' => 'Pollo guisado lento con naranjilla, arroz flor y salsa de cilantro. Acompañado de maduro.',
            'default_price' => 8.90,
            'tracks_lots' => false,
            'is_sellable' => true,
        ...
        $jugo = Product::query()->create([
            ...
            'sku' => 'BEB-NARA',
            'description' => 'Naranjilla de finca, hielo y hierba luisa. Ácido, fresco y sin azúcar añadida.',
            'default_price' => 2.50,
            'tracks_lots' => false,
            'is_sellable' => true,
            'prep_time_minutes' => 4,
        ...
        foreach ([
            ...
            ['entradas', 'Humitas', 'ENT-HUMITA', 'Choclo tierno molido, envuelto en hoja y al vapor. Mantequilla y queso.', 3.80, 14, ['lácteos'], 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?auto=format&fit=crop&w=800&q=80', 'porcion'],
            ['entradas', 'Bolón de verde', 'ENT-BOLON', 'Verde maduro, chicharrón y queso. Se sirve caliente, para compartir.', 4.20, 12, ['lácteos'], 'https://images.unsplash.com/photo-1603133872878-684f208fb84b?auto=format&fit=crop&w=800&q=80', 'porcion'],
            ...
            ['bebidas', 'Jugo de taxo', 'BEB-TAXO', 'Taxo de finca, hielo y un toque de miel de abeja. Ácido y aromático.', 2.80, 4, null, 'https://images.unsplash.com/photo-1572490122747-3968b75cc699?auto=format&fit=crop&w=800&q=80', 'und'],
            ['bebidas', 'Café de palo', 'BEB-CAFE', 'Café de altura, prensa francesa. Se sirve solo o con leche de hacienda.', 2.20, 5, ['lácteos'], 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?auto=format&fit=crop&w=800&q=80', 'und'],
            ...
            ['postres', 'Espumilla', 'POS-ESPU', 'Clara montada con guayaba y galleta. Postre de feria quiteña.', 2.50, 6, ['huevo', 'gluten'], 'https://images.unsplash.com/photo-1488477181946-6428a0291777?auto=format&fit=crop&w=800&q=80', 'und'],
            ['postres', 'Higos con queso', 'POS-HIGOS', 'Higos en almíbar de panela y queso fresco. Dulce y salado.', 3.40, 4, ['lácteos'], 'https://images.unsplash.com/photo-1464349095431-e9a21285b5f3?auto=format&fit=crop&w=800&q=80', 'und'],
